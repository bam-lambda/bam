...
module.exports = {
  ...
  redeploy: {
    ...
    options: [
      ...
      { name: 'addEndpoint', description: 'adds API Gateway endpoint (if none exists) that is integrated with the lamdba' },
    ],
    hasResource: true,
  },
  create: {
  ...
  delete: {
    ...
    options: [
      ...
      { name: 'endpointOnly', description: 'deletes only the API Gateway' },
